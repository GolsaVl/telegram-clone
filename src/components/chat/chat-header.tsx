    ...
    <div className="flex h-16 items-center justify-between border-b border-gray-200 dark:border-gray-800 px-4 bg-white dark:bg-gray-900">
      <div className="flex items-center gap-3">
        ...
        {displayAvatar ? (
          ...
          <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-200 text-sm font-medium uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-300">
